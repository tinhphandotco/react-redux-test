...
export default function Lightweight({ width = 400, height = 300}) {
  useEffect(() => {
    ...
    const chart = createChart(document.getElementById("chart"), {
      ...
      layout: {
        backgroundColor: '#1e3649'
      },
    });

    const areaSeries = chart.addAreaSeries({
      symbol: 'AAPL',
      topColor: 'rgba(139, 202, 255, 0.2)',
      bottomColor: 'rgba(139, 202, 255, 0)',
      lineColor: '#76c0ff',
      lineWidth: 2
    });
